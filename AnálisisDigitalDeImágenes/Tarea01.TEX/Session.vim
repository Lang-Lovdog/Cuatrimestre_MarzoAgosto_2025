...
badd +15 code/src/main.cpp
badd +1 code/dibujo.cxx
badd +1 code/dibujo.hxx
badd +742 code/src/OCV_Course.cxx
badd +8 code/src/dibujo.cxx
badd +10 code/src/dibujo.hxx
badd +0 code/Makefile
badd +0 code/src/OCV_Course.hxx
argglobal
%argdel
...
exe 'vert 2resize ' . ((&columns * 99 + 134) / 268)
exe '3resize ' . ((&lines * 38 + 40) / 80)
exe 'vert 3resize ' . ((&columns * 99 + 134) / 268)
exe 'vert 4resize ' . ((&columns * 137 + 134) / 268)
argglobal
enew
file NvimTree_1
...
exe 'vert 4resize ' . ((&columns * 137 + 134) / 268)
tabnext
edit ~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.hxx
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
argglobal
balt ~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.cxx
setlocal foldmethod=expr
setlocal foldexpr=nvim_treesitter#foldexpr()
setlocal foldmarker={{{,}}}
setlocal foldignore=#
...
wincmd w
argglobal
if bufexists(fnamemodify("~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.cxx", ":p")) | buffer ~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.cxx | else | edit ~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.cxx | endif
if &buftype ==# 'terminal'
  silent file ~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.cxx
endif
balt ~/Documents/ACAD/MAESTRÍA/Cuatrimestre_MarzoAgosto_2025/AnálisisDigitalDeImágenes/Tarea01.TEX/code/src/OCV_Course.hxx
setlocal foldmethod=expr
setlocal foldexpr=nvim_treesitter#foldexpr()
setlocal foldmarker={{{,}}}
setlocal foldignore=#
...
setlocal foldnestmax=20
setlocal foldenable
let s:l = 607 - ((606 * winheight(0) + 38) / 77)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 607
