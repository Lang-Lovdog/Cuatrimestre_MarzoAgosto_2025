...
\pandocbounded{\includegraphics[keepaspectratio]{perceptron_files/figure-pdf/cell-7-output-1.png}}

\subsection{Perceptron training and
results}\label{perceptron-training-and-results}
...
\pandocbounded{\includegraphics[keepaspectratio]{perceptron_files/figure-pdf/cell-9-output-1.png}}
