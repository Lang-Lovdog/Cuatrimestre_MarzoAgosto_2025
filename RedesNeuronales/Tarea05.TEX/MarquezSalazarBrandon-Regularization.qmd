...
# Conclusions
Within this experiment, we can observe the different behaviours from different regularization
methods applied to a simple ANN, using the iris dataset.

The effectiveness of a regularization method usually depends on it's definition. And the most effective,
leaving a good training timing without overfitting, for this particular experiment, were the Dropout and
BatchNorm methods.
